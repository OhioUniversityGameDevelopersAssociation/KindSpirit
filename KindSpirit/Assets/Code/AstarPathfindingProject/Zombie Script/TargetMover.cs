...
namespace Pathfinding {
	...
	public class TargetMover : MonoBehaviour {
		...
		public bool onlyOnDoubleClick = false; //update every frame because player moves- Julie
		...
		public void UpdateTargetPosition () {
			...
			if (use2D) {
				//newPosition = cam.ScreenToWorldPoint(Input.mousePosition);//change this!!
				//GameObject.FindObjectOfType<retaindata>();
